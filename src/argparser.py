...
OptionsParser.add_argument('--add', '-a', default=False, action='store_true', required=False, help="Enables add mode. In add mode, you can add categories with the category flag, or add an item to a category, with a combination of the category and item flags. ")
